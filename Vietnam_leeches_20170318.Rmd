...
```{r}
reservecode_by_OTU <- Sample_by_OTU_mammals %>% dplyr::select(Country, reservecode, reservecode2,reservecode3, Protected_Area_Std_Name, Artiodactyla.Bovidae.Bos.taurus:Soricomorpha.Talpidae.Euroscaptor.UNK)
...
reservecode_by_OTU_readsum <- reservecode_by_OTU %>% 
	group_by_at(vars(Country, reservecode, reservecode2, reservecode3)) %>% 
