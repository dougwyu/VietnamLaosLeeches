...
```
plot(arth.jmds,display="sites",type="n")
with(arthropods.env,ordisurf(arth.jmds,avpctbare,col="red",main=""))
with(arthropods.env,ordispider(arth.jmds, treatment,cex=.5, draw="polygon",col=c("red"),alpha=10,kind="se",conf=0.95,
                               show.groups=(c("Heath"))))
with(arthropods.env,ordihull(arth.jmds, treatment,cex=.5, draw="polygon",col=c("black"),alpha=100,kind="se",conf=0.95,label=TRUE, 
                             show.groups=(c("1Control"))))
with(arthropods.env,ordiellipse(arth.jmds, treatment,cex=.5, draw="polygon",col=c("blue"),alpha=10,kind="se",conf=0.95,label=FALSE, 
                                show.groups=(c("ForageHarvest","ForestPlough","Disc","Swipe"))))
with(arthropods.env,ordiellipse(arth.jmds, treatment,cex=.5, draw="polygon",col=c("green"),alpha=50,kind="se",conf=0.95,label=TRUE, 
                                show.groups=(c("TurfStrip","AgriPlough"))))
heatmap
