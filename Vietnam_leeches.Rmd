...
communities <- c("leechidna_named_mammals_t", "leechidna_carnivora_t", "leechidna_critters_t", "leechidna_artiodactyla_t", "leechidna_primates_t")
community <- communities[5]

rowSums(get(community))
dca <- decorana(get(community))
tabasco(decostand(get(community), "log"), dca)
city_complex.jmds <- metaMDS(city_complex.dis, dist="jaccard")
