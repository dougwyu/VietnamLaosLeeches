...
for (i in seq_along(varNames)) {
  ...
  assign(paste0("OTU_by_Site_", varNames[i]), dreserve) # create site X species tables
...
Create Site X Species table, with Reserve_StdName and Reserve_SubName as first two columns.  # not done yet
```{r Site X Species tables, eval=FALSE}
varNames <- c("named_mammals", "carnivora", "critters", "cetartiodactyla", "primates")
